<template>
  ...
  >
    ...
    >
      ...
      <!-- User -->
      <Link :href="route('password.request')" class="cursor-pointer lg:md:block text-left md:pb-2 text-blueGray-600 mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0">
            Automated SitRep
      </Link>
